      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <!-- <div class="table-responsive"> -->
            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('admin/category/store') ?>">
              <div class="container">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <input class="form-control" value="<?php echo set_value('name') ?>" name="name" id="name" type="text" placeholder="请输入分类名称">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-5 col-md-6">
                      <input class="form-control" type="text" name="description" placeholder="请输入分类描述">
                    </div>
                </div>
        ...
        $("#level").change(function(){
            ...
            $.ajax({
                ...
                success:function(data,textStatus,jqXHR){
                    html = '<option value="">未选择父类</option>'
